...
var testLogger = log.NewLogger("index_test", log.WithSink(buf), log.WithVerbosity(log.VerbosityDebug))
...
func TestIterate(t *testing.T) {
	...
	t.Run("persisted", func(t *testing.T) {
		...
		mode := pot.NewPersistedPot(pot.NewSingleOrder(32), ls, func() pot.Entry { return &mockEntry{} })
...
func TestSize(t *testing.T) {
	...
	t.Run("persisted", func(t *testing.T) {
		...
		mode := pot.NewPersistedPot(basePotMode, ls, func() pot.Entry { return &mockEntry{} })
		idx, err := potter.New(mode, testLogger)
		if err != nil {
			t.Fatal(err)
		}
